...
from .models import cases, labs, quarantine, sqliteseq, summery


class casesSerializer(serializers.ModelSerializer):
    class Meta:
        model = cases
        fields = ['id', 'datetime', 'time', 'reference', 'description', 'extra']
...
class vaccineSerializer(serializers.ModelSerializer):
    class Meta:
        model = summery
        fields = ['id', 'datetime', 'total_fully', 'total_partially', 'total_doses', 'last_fully', 'last_partially', 'last_doses', 'reference']
